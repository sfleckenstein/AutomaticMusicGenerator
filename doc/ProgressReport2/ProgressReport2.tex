...
goal, but this project use a \text{TODO: is it just a hierarchical HMM?} hidden Markov model to extract these patterns. This model was chosen because
...
\text{TODO: how are we handling this with the HHMM?} 
\begin{enumerate}
...
\subsection{Composition Agent}
\text{TODO: This is completely different, based largely on the learner}
\begin{enumerate}
...
\text{TODO: does this seem reasonable?}
...
\\
\text{TODO: Ross, please fill in what you have been doing with the HHMMs}

\subsection{Composition Agent}
The composition agent has not been started, and will be the primary focus of the next phase in development.

\subsection{User Interface}
\text{TODO: Ross, please fill in what you have done with the UI}
...
Given that the project was called unoriginal and uninnovative during it's last review, large changes have been
 made to the learning model that will be used. \text{TODO: Ross, please fill the some basics about HHMMs}
